...
class BranchAndBoundQueue(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        self.A = sorted(self.A, key = lambda items: items.path_cost, reverse = True)#También puede ser self.A.sort(reverse = True, key = lambda items: items.path_cost)
    ...
    def pop(self):
      ...
      '''
        ...
        return e
      '''
class InformedPriorityQueue(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        self.A = sorted(self.A, key = lambda item: item.path_cost + self.problem.h(item), reverse = True)#También puede ser self.A.sort(reverse = True, key = lambda items: items.path_cost)
